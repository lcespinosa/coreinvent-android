...
public class MovementTagFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_movement_tag, container, false);
    }
...
//        });
        ...
        forward_img.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(v).navigate(R.id.action_movement_tag_fragment_to_movement_location_fragment);
            }
        });
    }
}
